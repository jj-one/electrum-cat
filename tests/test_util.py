...
from electrum_cat.util import (format_satoshis, format_fee_satoshis, is_hash256_str, chunks, is_ip_address,
                           ...
                           ShortID)
from electrum_cat.bip21 import parse_bip21_URI, InvalidBitcoinURI
...
class TestUtil(ElectrumTestCase):
    ...
    def test_parse_URI_address(self):
        self._do_test_parse_URI('catcoin:9f1JJetiEMmPUGRTTT1vNtNQpWcW3iV3Tt',
                                {'address': '9f1JJetiEMmPUGRTTT1vNtNQpWcW3iV3Tt'})

    def test_parse_URI_only_address(self):
        self._do_test_parse_URI('9f1JJetiEMmPUGRTTT1vNtNQpWcW3iV3Tt',
                                {'address': '9f1JJetiEMmPUGRTTT1vNtNQpWcW3iV3Tt'})


    def test_parse_URI_address_label(self):
        self._do_test_parse_URI('catcoin:9f1JJetiEMmPUGRTTT1vNtNQpWcW3iV3Tt?label=electrum%20test',
                                {'address': '9f1JJetiEMmPUGRTTT1vNtNQpWcW3iV3Tt', 'label': 'electrum-cat test'})

    def test_parse_URI_address_message(self):
        self._do_test_parse_URI('catcoin:9f1JJetiEMmPUGRTTT1vNtNQpWcW3iV3Tt?message=electrum%20test',
                                {'address': '9f1JJetiEMmPUGRTTT1vNtNQpWcW3iV3Tt', 'message': 'electrum-cat test', 'memo': 'electrum-cat test'})

    def test_parse_URI_address_amount(self):
        self._do_test_parse_URI('catcoin:9f1JJetiEMmPUGRTTT1vNtNQpWcW3iV3Tt?amount=0.0003',
                                {'address': '9f1JJetiEMmPUGRTTT1vNtNQpWcW3iV3Tt', 'amount': 30000})

    def test_parse_URI_address_request_url(self):
        self._do_test_parse_URI('catcoin:9f1JJetiEMmPUGRTTT1vNtNQpWcW3iV3Tt?r=http://domain.tld/page?h%3D2a8628fc2fbe',
                                {'address': '9f1JJetiEMmPUGRTTT1vNtNQpWcW3iV3Tt', 'r': 'http://domain.tld/page?h=2a8628fc2fbe'})

    def test_parse_URI_ignore_args(self):
        self._do_test_parse_URI('catcoin:9f1JJetiEMmPUGRTTT1vNtNQpWcW3iV3Tt?test=test',
                                {'address': '9f1JJetiEMmPUGRTTT1vNtNQpWcW3iV3Tt', 'test': 'test'})

    def test_parse_URI_multiple_args(self):
        self._do_test_parse_URI('catcoin:9f1JJetiEMmPUGRTTT1vNtNQpWcW3iV3Tt?amount=0.00004&label=electrum-test&message=electrum%20test&test=none&r=http://domain.tld/page',
                                {'address': '9f1JJetiEMmPUGRTTT1vNtNQpWcW3iV3Tt', 'amount': 4000, 'label': 'electrum-cat-test', 'message': u'electrum-cat test', 'memo': u'electrum-cat test', 'r': 'http://domain.tld/page', 'test': 'none'})

    def test_parse_URI_no_address_request_url(self):
        self._do_test_parse_URI('catcoin:?r=http://domain.tld/page?h%3D2a8628fc2fbe',
                                {'r': 'http://domain.tld/page?h=2a8628fc2fbe'})

    def test_parse_URI_invalid_address(self):
        self.assertRaises(InvalidBitcoinURI, parse_bip21_URI, 'catcoin:invalidaddress')

    def test_parse_URI_invalid(self):
        self.assertRaises(InvalidBitcoinURI, parse_bip21_URI, 'notcatcoin:9f1JJetiEMmPUGRTTT1vNtNQpWcW3iV3Tt')

    def test_parse_URI_parameter_pollution(self):
        self.assertRaises(InvalidBitcoinURI, parse_bip21_URI, 'catcoin:9f1JJetiEMmPUGRTTT1vNtNQpWcW3iV3Tt?amount=0.0003&label=test&amount=30.0')
    ...
    def test_parse_URI_lightning_consistency(self):
        ...
        self._do_test_parse_URI('catcoin:?lightning=',
                                {'lightning': ''})
        # bip21 uri that *only* includes a "lightning" key. LN part has fallback address
        self._do_test_parse_URI('catcoin:?lightning=',
                                {'lightning': ''})
        # bip21 uri that includes "lightning" key. LN part does not have fallback address
        self._do_test_parse_URI('catcoin:tcat1qu5ua3szskclyd48wlfdwfd32j65phxy9yf7ytl?amount=0.0007&message=test266&lightning=',
                                {'address': 'tcat1qu5ua3szskclyd48wlfdwfd32j65phxy9yf7ytl',
                                 'amount': 70000,
                                 'lightning': '',
                                 'memo': 'test266',
                                 'message': 'test266'})
        ...
        self.assertRaises(InvalidBitcoinURI, parse_bip21_URI, 'catcoin:tcat1qvu0c9xme0ul3gzx4nzqdgxsu25acuk9wvsj2j2?amount=0.0007&message=test266&lightning=')
        # bip21 uri that includes "lightning" key. top-level amount mismatches LN amount
        self.assertRaises(InvalidBitcoinURI, parse_bip21_URI, 'catcoin:tcat1qu5ua3szskclyd48wlfdwfd32j65phxy9yf7ytl?amount=0.0008&message=test266&lightning=')
        # bip21 uri that includes "lightning" key with garbage unparsable value
        self.assertRaises(InvalidBitcoinURI, parse_bip21_URI, 'catcoin:tcat1qu5ua3szskclyd48wlfdwfd32j65phxy9yf7ytl?amount=0.0008&message=test266&lightning=lntb700u1p3kqy26pp5l7rj7w0u5sdsj24umzdlhdasdasdasdasd')
