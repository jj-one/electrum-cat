...
from electrum_cat.plugins.hw_wallet import plugin
from electrum_cat.gui.qt.wizard.wallet import WCScriptAndDerivation, WCHWUnlock, WCHWXPub, WCHWUninitialized
