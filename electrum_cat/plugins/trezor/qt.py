...
from electrum_cat.keystore import ScriptTypeNotSupported
...
from electrum_cat.plugins.hw_wallet.plugin import only_hook_if_libraries_available, OutdatedHwFirmwareException
