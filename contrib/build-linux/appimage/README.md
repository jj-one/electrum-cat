AppImage binary for Electrum-CAT
============================
...
Execute the binary as follows: `./electrum-cat*.AppImage --appimage-extract`

### How to investigate diff between binaries if reproducibility fails?
```
cd dist/
./electrum-cat-*-x86_64.AppImage1 --appimage-extract
mv squashfs-root/ squashfs-root1/
./electrum-cat-*-x86_64.AppImage2 --appimage-extract
