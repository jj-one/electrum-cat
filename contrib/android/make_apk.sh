...
# defaults:
#   export APP_PACKAGE_NAME=ElectrumCAT
#   export APP_PACKAGE_DOMAIN=org.catcoin.electrumcat
...
#export APP_PACKAGE_DOMAIN=org.catcoin.testnet
...
if [[ "$3" == "release" ]] ; then
    ...
    export P4A_RELEASE_KEYSTORE=~/.keystore/electrumcat.keystore
    export P4A_RELEASE_KEYALIAS=electrumcat
    ...
    export P4A_DEBUG_KEYALIAS=electrumcat
